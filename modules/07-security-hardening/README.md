# Module 07: Security Hardening & Pod Security
...
- Understand the core concepts of Security Hardening & Pod Security
...
### What is Security Hardening & Pod Security?

Security Hardening & Pod Security is a fundamental component of EKS Production Ready: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Security Hardening & Pod Security like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/07-security-hardening/
```
...
```bash
ls modules/07-security-hardening/lab/starter/
```
...
cd modules/07-security-hardening/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/07-security-hardening/validation/validate.sh
```
...
1. What is the main purpose of Security Hardening & Pod Security?
...
- [ ] Validation script passes: `bash modules/07-security-hardening/validation/validate.sh`
...
**Next: [Module 08 →](../08-secrets-and-iam/)**
