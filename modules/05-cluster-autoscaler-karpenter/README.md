# Module 05: Cluster Autoscaler & Karpenter
...
- Understand the core concepts of Cluster Autoscaler & Karpenter
...
### What is Cluster Autoscaler & Karpenter?

Cluster Autoscaler & Karpenter is a fundamental component of EKS Production Ready: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Cluster Autoscaler & Karpenter like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/05-cluster-autoscaler-karpenter/
```
...
```bash
ls modules/05-cluster-autoscaler-karpenter/lab/starter/
```
...
cd modules/05-cluster-autoscaler-karpenter/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/05-cluster-autoscaler-karpenter/validation/validate.sh
```
...
1. What is the main purpose of Cluster Autoscaler & Karpenter?
...
- [ ] Validation script passes: `bash modules/05-cluster-autoscaler-karpenter/validation/validate.sh`
...
**Next: [Module 06 →](../06-observability/)**
