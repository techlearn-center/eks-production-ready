# Module 03: VPC, Subnets & Security Groups
...
- Understand the core concepts of VPC, Subnets & Security Groups
...
### What is VPC, Subnets & Security Groups?

VPC, Subnets & Security Groups is a fundamental component of EKS Production Ready: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of VPC, Subnets & Security Groups like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/03-networking-and-vpc/
```
...
```bash
ls modules/03-networking-and-vpc/lab/starter/
```
...
cd modules/03-networking-and-vpc/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-networking-and-vpc/validation/validate.sh
```
...
1. What is the main purpose of VPC, Subnets & Security Groups?
...
- [ ] Validation script passes: `bash modules/03-networking-and-vpc/validation/validate.sh`
...
**Next: [Module 04 →](../04-alb-ingress-controller/)**
