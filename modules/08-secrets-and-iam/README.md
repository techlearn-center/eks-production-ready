# Module 08: Secrets Manager & IAM Roles for Service Accounts
...
- Understand the core concepts of Secrets Manager & IAM Roles for Service Accounts
...
### What is Secrets Manager & IAM Roles for Service Accounts?

Secrets Manager & IAM Roles for Service Accounts is a fundamental component of EKS Production Ready: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Secrets Manager & IAM Roles for Service Accounts like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/08-secrets-and-iam/lab/starter/
```
...
cd modules/08-secrets-and-iam/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-secrets-and-iam/validation/validate.sh
```
...
1. What is the main purpose of Secrets Manager & IAM Roles for Service Accounts?
...
- [ ] Validation script passes: `bash modules/08-secrets-and-iam/validation/validate.sh`
...
**Next: [Module 09 →](../09-ci-cd-eks-deployment/)**
